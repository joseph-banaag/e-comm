...
const Navbar = () => {
  return (
    <nav
      className="w-full h-auto md:min-h-16 flex justify-center items-center text-xs font-medium px-1 py-3 shadow-lg bg-linear-to-r from-blue-600 to-purple-950 text-[#e1e1e3]">
